...
<sql:query   var = "report">
    select Loads.Total_Miles, Drop_Off_Location.Drop_Off_Tracker_Code, States.State_Name, Pick_Up_location.Pick_Up_Tracker_Code
    from Loads
    ...
    WHERE Drop_Off_Location.Drop_Off_Date = Pick_Up_location.Pick_Up_Date
</sql:query>
