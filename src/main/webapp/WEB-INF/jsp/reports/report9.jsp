...
<sql:query   var = "report">
    SELECT Loads.Date, Pick_Up_Tracker_Code, Pick_Up_location.Street_Address, Drop_Off_Tracker_Code, Drop_Off_Location.Street_Address, employee.First_Name, employee.Last_Name, Truck.Make, Truck.Model, Truck.License_Plate
    FROM loads
...
<table class="table table-bordered">
    <tr>
        <th>Date</th>
        <th>Pick Up Tracker</th>
        <th>Pick Up Address</th>
        <th>Drop Off Tracker</th>
    ...
    <c:forEach var = "row" items = "${report.rows}">
        <tr>
            ...
            <td><c:out value = "${row.License_Plate}"/></td>
        </tr>
    </c:forEach>
</table>
