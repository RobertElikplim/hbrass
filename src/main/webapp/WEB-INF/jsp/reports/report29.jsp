...
<sql:query   var = "report">
    SELECT Loads.Client_ID, Pick_Up_location.Pick_Up_Tracker_Code, Drop_Off_Location.Drop_Off_Tracker_Code, States.State_Name
    FROM Loads
    ...
    WHERE Drop_Off_Location.State_Code = States.State_Code
</sql:query>
