...
<sql:query   var = "report">
    select loads.Load_ID,employee.First_Name, employee.Last_Name, Truck_Driver.State_Code, Trip_Expense.Total_Expense, Fuel_Cost,
    Repair_Expense, Other_Expense, Pick_Up_location.Pick_Up_Date,Drop_Off_Location.Drop_Off_Date
    from Loads
    ...
    where Drop_Off_Date between '20200630' and '20210101'
</sql:query>
