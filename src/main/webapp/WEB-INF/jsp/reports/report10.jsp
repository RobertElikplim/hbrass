...
<sql:query   var = "report">
    select loads.Load_ID,employee.First_Name, employee.Last_Name, Truck_Driver.Driver_ID,
    Trip_Expense.Total_Expense, Pick_Up_location.Pick_Up_Date,Drop_Off_Location.Drop_Off_Date
    from Loads
    ...
    where Drop_Off_Date between '20200101' and '20200401'
</sql:query>
